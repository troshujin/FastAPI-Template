...
from app.permission import AllowAll, IsAdmin, IsAuthenticated, IsUserOwner
...
from core.fastapi.dependencies.permission import AND, OR, PermissionDependency
...
@version(1)
async def get_user(
    user_id: str = Depends(get_path_user_id), session: Session = Depends(get_db)
):
...
async def update_user(
    ...
    user_id: str = Depends(get_path_user_id),
